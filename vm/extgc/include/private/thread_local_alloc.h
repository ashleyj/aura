...
# define GC_remove_specific(key) (pthread_setspecific(key, NULL)) /* RoboVM note: This used to be a noop.
                                                                     We want it to be explicitly deleted to 
                                                                     stop the TLS destructor from being 
                                                                     called repeatedly. */
