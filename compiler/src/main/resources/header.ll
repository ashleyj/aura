...
define private void @intrinsics.aura_rt_VM_memmove8(%Env* %env, i64 %s1, i64 %s2, i64 %n) alwaysinline {
...
define private void @intrinsics.aura_rt_VM_memmove16(%Env* %env, i64 %s1, i64 %s2, i64 %n) alwaysinline {
    %dest = inttoptr i64 %s1 to i8*
    %src = inttoptr i64 %s2 to i8*
...
define private void @intrinsics.aura_rt_VM_memmove32(%Env* %env, i64 %s1, i64 %s2, i64 %n) alwaysinline {
    %dest = inttoptr i64 %s1 to i8*
    %src = inttoptr i64 %s2 to i8*
...
define private void @intrinsics.aura_rt_VM_memmove64(%Env* %env, i64 %s1, i64 %s2, i64 %n) alwaysinline {
    %dest = inttoptr i64 %s1 to i8*
    %src = inttoptr i64 %s2 to i8*
    %n2 = shl i64 %n, 1
