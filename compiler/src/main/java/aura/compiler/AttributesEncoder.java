...
import aura.compiler.llvm.ArrayConstant;
...
import aura.compiler.llvm.PackedStructureConstant;
...
public class AttributesEncoder {
    ...
    private PackedStructureType getAnnotationElementType(AnnotationElem ae) {
        if (ae instanceof AnnotationIntElem) {
            return new PackedStructureType(Type.I8, Type.I32);
        } else if (ae instanceof AnnotationLongElem) {
            return new PackedStructureType(Type.I8, Type.I64);
        } else if (ae instanceof AnnotationFloatElem) {
            return new PackedStructureType(Type.I8, Type.FLOAT);
        } else if (ae instanceof AnnotationDoubleElem) {
            return new PackedStructureType(Type.I8, Type.DOUBLE);
        } else if (ae instanceof AnnotationStringElem) {
            return new PackedStructureType(Type.I8, Type.I8_PTR);
        } else if (ae instanceof AnnotationClassElem) {
            return new PackedStructureType(Type.I8, Type.I8_PTR);
        } else if (ae instanceof AnnotationEnumElem) {
            return new PackedStructureType(Type.I8, Type.I8_PTR, Type.I8_PTR);
            ...
            return new PackedStructureType(Type.I8, getAnnotationTagType(aae.getValue()));
        }
    ...
    private Constant encodeAttributes(Host host) {
        ...
        for (Tag tag : host.getTags()) {
            if (tag instanceof SourceFileTag) {
                ...
                attributes.add(new PackedStructureConstant(new PackedStructureType(Type.I8, Type.I8_PTR),
                ...
                attributes.add(new PackedStructureConstant(new PackedStructureType(Type.I8, Type.I8_PTR, Type.I8_PTR, Type.I8_PTR),
                ...
                attributes.add(new PackedStructureConstant(new PackedStructureType(Type.I8, Type.I8_PTR, Type.I8_PTR, Type.I8_PTR, Type.I32),
                ...
                attributes.add(new PackedStructureConstant(new PackedStructureType(Type.I8, value.getType()),
                ...
                if (vat.getVisibility() == AnnotationConstants.RUNTIME_VISIBLE) {
                    ...
                    attributes.add(new PackedStructureConstant(new PackedStructureType(Type.I8, Type.I32, new PackedStructureType(types)),
        ...
        if (host instanceof SootMethod) {
            ...
            if (!exceptions.isEmpty()) {
                ...
                attributes.add(new PackedStructureConstant(new PackedStructureType(Type.I8, Type.I32, new ArrayType(exceptions.size(), Type.I8_PTR)),
                        new IntegerConstant(EXCEPTIONS), new IntegerConstant(exceptions.size()), 
                        new ArrayConstant(new ArrayType(exceptions.size(), Type.I8_PTR), values)));
            }
        }
