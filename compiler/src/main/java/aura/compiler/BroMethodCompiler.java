...
import aura.compiler.llvm.Inttoptr;
import aura.compiler.llvm.Load;
import aura.compiler.llvm.PointerType;
import aura.compiler.llvm.PrimitiveType;
import aura.compiler.llvm.Ptrtoint;
...
public abstract class BroMethodCompiler extends AbstractMethodCompiler {
    ...
    protected Value marshalNativeToObject(Function fn, MarshalerLookup.MarshalerMethod marshalerMethod,
        ...
        Value object = Functions.call(fn, invokestatic.getFunctionRef(),
    ...
    protected Value marshalNativeToValueObject(Function fn, MarshalerLookup.MarshalerMethod marshalerMethod, Value env,
        ...
        return Functions.call(fn, invokeToObject.getFunctionRef(), env, valueClass, nativeValue, new IntegerConstant(flags));
    }
    ...
    protected Value marshalObjectToNative(Function fn, MarshalerLookup.MarshalerMethod marshalerMethod, MarshaledArg marshaledArg,
        ...
        trampolines.add(invokestatic);
        Value handle = Functions.call(fn, invokestatic.getFunctionRef(),
    ...
    protected Value marshalValueObjectToNative(Function fn, MarshalerLookup.MarshalerMethod marshalerMethod,
        ...
        Invokestatic invokestatic = marshalerMethod.getInvokeStatic(
                sootMethod.getDeclaringClass());
        trampolines.add(invokestatic);
        Value result = Functions.call(fn, invokestatic.getFunctionRef(), env, object, new IntegerConstant(flags));
    ...
    private StructureType getStructType(SootClass clazz, boolean checkEmpty) {
        ...
        if (clazz.hasSuperclass()) {
            ...
            if (!superclass.getName().equals("Struct")) {
    ...
    public Type getStructMemberType(SootMethod method) {
        ...
        } else if (getter != null && (Annotations.hasMachineSizedSIntAnnotation(getter) || Annotations.hasMachineSizedUIntAnnotation(getter))
                || setter != null && (Annotations.hasMachineSizedSIntAnnotation(setter, 0) || Annotations.hasMachineSizedUIntAnnotation(setter, 0))) {
    ...
    protected SootMethod createFakeStructRetMethod(SootMethod originalMethod) {
        ...
        Annotations.addRuntimeVisibleParameterAnnotation(method, 0, Annotations.STRUCT_RET);
        return method;
    }
        ...
        if (Bro.needsMarshaler(type)) {
            ...
            if (memberType instanceof PrimitiveType) {
                ...
                if (memberType instanceof StructureType || memberType instanceof ArrayType) {
                    ...
                    // Object isn't null.
                    Functions.call(function, Functions.CHECK_NULL, env, value);
                }
