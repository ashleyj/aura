...
import aura.compiler.llvm.Metadata;
import aura.compiler.llvm.Module;
import aura.compiler.llvm.NamedMetadata;
import aura.compiler.llvm.NullConstant;
import aura.compiler.llvm.StringConstant;
import aura.compiler.llvm.UnnamedMetadata;
import aura.compiler.llvm.UserType;
...
public class ModuleBuilder {
    ...
    public Constant getString(String string) {
        ...
        if (g == null) {
            ...
            g = new Global(Strings.getStringVarName(modUtf8), Linkage.weak,
