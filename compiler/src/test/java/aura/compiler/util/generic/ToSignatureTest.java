...
public class ToSignatureTest {
    ...
    public void testMethodParamSignature() {
        ...
        assertEquals("Laura/compiler/util/generic/ToSignatureTest$A<Ljava/lang/Number;*>;", 
                type.toGenericSignature());
        type = methodParamType("m1", 3);
        assertEquals("Laura/compiler/util/generic/ToSignatureTest$A<Ljava/lang/Number;+Ljava/lang/Comparable<Ljava/lang/String;>;>;", 
                type.toGenericSignature());
        type = methodParamType("m1", 4);
        assertEquals("Laura/compiler/util/generic/ToSignatureTest$B<Ljava/lang/Integer;>.Inner<Ljava/lang/String;>;", 
                type.toGenericSignature());
    }
