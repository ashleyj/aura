...
public class MarshalerLookupTest {
    ...
    @aura.rt.bro.annotation.Marshaler(M1.class)
    ...
    @aura.rt.bro.annotation.Marshaler(M2.class)
    public interface I1 {}
    @aura.rt.bro.annotation.Marshaler(M3.class)
    public interface I2 {}
    @aura.rt.bro.annotation.Marshaler(M4.class)
    public interface I3 {}
    @Marshalers({
        @aura.rt.bro.annotation.Marshaler(M5.class),
        @aura.rt.bro.annotation.Marshaler(M1.class)
    })
    public interface I4 {}
    public interface I5 extends I3, I4 {}
    @aura.rt.bro.annotation.Marshaler(M6.class)
    public interface I6 {}
    
    public static class C3 extends C2 implements I1, I5 {
    }

    @aura.rt.bro.annotation.Marshaler(M7.class)
    ...
    public static class Foo3 {
        @Bridge
        private static native @aura.rt.bro.annotation.Marshaler(M1.class) String 
            foo(@aura.rt.bro.annotation.Marshaler(M1.class) String s);
    }
    @aura.rt.bro.annotation.Marshaler(M2.class)
