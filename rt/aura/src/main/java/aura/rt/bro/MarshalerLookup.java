...
import aura.rt.bro.annotation.MarshalsPointer;
...
public class MarshalerLookup {
    ...
    private static Method find(Class<?> findClass, Class<?> inClass, aura.rt.bro.annotation.Marshaler anno) {
    ...
    private static Method findMarshaler0(Class<?> findClass, Class<?> inClass) {
        aura.rt.bro.annotation.Marshaler anno1 =
                inClass.getAnnotation(aura.rt.bro.annotation.Marshaler.class);
        aura.rt.bro.annotation.Marshalers anno2 =
                inClass.getAnnotation(aura.rt.bro.annotation.Marshalers.class);
        if (anno1 != null) {
        ...
        if (anno2 != null) {
            for (aura.rt.bro.annotation.Marshaler m : anno2.value()) {
