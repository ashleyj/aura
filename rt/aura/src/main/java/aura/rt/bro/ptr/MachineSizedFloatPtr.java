...
import aura.rt.bro.annotation.MachineSizedFloat;
...
public final class MachineSizedFloatPtr extends Struct<MachineSizedFloatPtr> {
     ...
     */
    public static class MachineSizedFloatPtrPtr extends aura.rt.bro.ptr.Ptr<MachineSizedFloatPtr, MachineSizedFloatPtrPtr> {}
     ...
     */
    @StructMember(0)
    public native @MachineSizedFloat
    double get();
